...
class _EditSupplierState extends State<EditSupplier> {
  ...
  _editsupplier(Supplier cst) async {
    ...
    if (mname.isEmpty ||
        ...
        maddress.isEmpty ||
        mprebal.isEmpty) {
      Get.snackbar("Supplier Update Failed.",
      ...
      FirebaseFirestore.instance.collection('Supplier').doc(cst.id).update({
        'Name': mname,
        'Phone': mphone,
        'Phone2': mphone2,'User':AuthService.to.user?.name,
        'Address': maddress,
        'Email': memail,
        ...
        Get.snackbar("Supplier Updated Successfully.",
  ...
  Widget build(BuildContext context) {
    ...
    var cst = Supplier.fromJson(jsonDecode(arguments['Supplier']));
    _addinit(cst);
      ...
      body: SingleChildScrollView(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              CustomText(
                  text: "Edit Supplier", size: 32, weight: FontWeight.bold),
              Container(
