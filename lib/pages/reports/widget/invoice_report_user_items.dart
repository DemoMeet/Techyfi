...
class InvoiceReportUserItems extends StatefulWidget {
  InvoiceListModel cst;
  int index;
  InvoiceReportUserItems(
      {required this.cst,
        required this.index,
      });

  @override
  State<InvoiceReportUserItems> createState() => _InvoiceReportUserItemsState();
}

class _InvoiceReportUserItemsState extends State<InvoiceReportUserItems> {
