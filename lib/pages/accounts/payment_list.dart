...
class _PaymentListState extends State<PaymentList> {
  ...
  List<bool> _click = [];
  List<PaymentVoucher> allPayment = [];
  List<PaymentVoucher> foundPayment = [];
  TextEditingController search_PaymentVoucher = TextEditingController();
  ...
  void _onEditPaymentVoucher(PaymentVoucher cst) {
  ...
  void _fetchDocuments() async {
    ...
    await FirebaseFirestore.instance
      ...
      querySnapshot.docs.forEach((element) {
        allPayment.add(PaymentVoucher(
            sl: s,
            payment: element["Payment"],
            selecteddate: element["Selected Date"],
  ...
  Widget build(BuildContext context) {
    ...
    Future<List<PaymentVoucher>> getCust() async {
      List<PaymentVoucher> Payment = [];
      _totalamount = 0;
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: TextField(
                              controller: search_PaymentVoucher,
