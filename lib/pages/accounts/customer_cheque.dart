...
class CustomerChequeReceive extends StatefulWidget {
  
  Navbools nn;
  CustomerChequeReceive({required this.nn});
  @override
  State<CustomerChequeReceive> createState() => _CustomerChequeReceiveState();
}

class _CustomerChequeReceiveState extends State<CustomerChequeReceive> {
  ...
  _addunit() async {
    ...
    if (_conchequenumber.text.isEmpty ||
      ...
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
        content: Text("All Fields are Required to Process Cheque Payment!!"),
      ));
    } else {
    ...
    await FirebaseFirestore.instance
      ...
      querySnapshot.docs.forEach((element) {
        supplier.add(Customer(
            ...
            city: element["City"],
            email: element["Email"],user: element["User"],
            id: element.id,
            name: element["Name"],
