...
class _AddUnitState extends State<AddUnit> {
  ...
  _addunit() async {
    ...
    if (cname.isEmpty) {
      ...
      FirebaseFirestore.instance.collection('Unit').add({
        'Name': cname,
        'status': cstats,
      }).then((value) {
        Get.offNamed(unitlistPageRoute);
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
            ...
            Expanded(
                child: Container(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      CustomText(text: "Add Unit", size: 32, weight: FontWeight.bold),
