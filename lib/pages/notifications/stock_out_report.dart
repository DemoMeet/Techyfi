...
class StockOutReport extends StatefulWidget {
  @override
  State<StockOutReport> createState() => _StockOutReportState();
}

class _StockOutReportState extends State<StockOutReport> {
  final NumberPaginatorController _controller = NumberPaginatorController();
  late ScrollController listScrollController;
  String dropdownvalue = 'Search By Name';
  int val = 0, _totalpagenum = 1, _currentpagenum = 1, _items = 10;
  bool _first = false, _nametop = false, _namebot = false, _stocktop = false, _stockbot =false;
  var chunks = [];
  var items = [
    10,
    25,
          ...
          if(!(totalmediqty>0)){
            allProducts.add(ProductStock(
                product: Product(
                  ...
                  strength: medi["Strength"],bodyrate: medi["Body Rate"],
                  unit: medi["Unit Name"],
                  img: medi["Image"],
