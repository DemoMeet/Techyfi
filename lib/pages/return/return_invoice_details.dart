...
class ReturnInvoiceDetails extends StatefulWidget {
  Return cst;
  Customer? ct;

  ReturnInvoiceDetails(this.cst, this.ct);
  @override
  State<ReturnInvoiceDetails> createState() => _ReturnInvoiceDetailsState();
}

class _ReturnInvoiceDetailsState extends State<ReturnInvoiceDetails> {
  @override
  void initState() {
    super.initState();
  }
