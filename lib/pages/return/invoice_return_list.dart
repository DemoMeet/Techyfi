...
class InvoiceReturnList extends StatefulWidget {
  ...
  InvoiceReturnList(
      { required this.nn});
  @override
  State<InvoiceReturnList> createState() => _InvoiceReturnListState();
}

class _InvoiceReturnListState extends State<InvoiceReturnList> {
  ...
  void _fetchDocuments() async {
    ...
    await FirebaseFirestore.instance
        .collection('Return').where('Purchase',isEqualTo: false)
        .get()
        .then((querySnapshot) {
