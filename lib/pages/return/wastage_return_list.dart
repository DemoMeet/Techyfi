...
class WastageReturnList extends StatefulWidget {
  ...
  WastageReturnList(
      { required this.nn});
  @override
  State<WastageReturnList> createState() => _WastageReturnListState();
}

class _WastageReturnListState extends State<WastageReturnList> {
