...
import '../return_invoice_details.dart';
import '../return_purchase_details.dart';

class InvoiceReturnListItem extends StatefulWidget {
  Return cst;
  int index;
  ...
  @override
  State<InvoiceReturnListItem> createState() => _InvoiceReturnListItemState();
}

class _InvoiceReturnListItemState extends State<InvoiceReturnListItem> {
  @override
