...
class ReturnPurListItem extends StatefulWidget {
  StockReturnItem cst;
  int index;
  ...
  @override
  State<ReturnPurListItem> createState() => _ReturnPurListItemState();
}

class _ReturnPurListItemState extends State<ReturnPurListItem> {
  @override
