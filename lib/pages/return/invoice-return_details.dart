...
class InvoiceReturnDetails extends StatefulWidget {
  InvoiceListModel cst;
  Customer mn;
  final void Function() refreshdata;

  InvoiceReturnDetails(this.cst, this.refreshdata, this.mn);
  @override
  State<InvoiceReturnDetails> createState() => _InvoiceReturnDetailsState();
}

class _InvoiceReturnDetailsState extends State<InvoiceReturnDetails> {
  @override
  void initState() {
    super.initState();
  }
          ...
          child: Column(
            children: [
              Container(
                ...
                child: CustomText(
                    text: "Invoice Details", size: 32, weight: FontWeight.bold),
              ),
              Container(
                                    ...
                                    child: FutureBuilder(
                                      builder: (ctx, AsyncSnapshot snapshot) {
                                        if (snapshot.hasError) {
                                          return const Center(
                                            child: Text(
                                                "No Invoice Return Data Available.."),
                                          );
