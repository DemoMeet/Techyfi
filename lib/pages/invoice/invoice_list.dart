...
class _InvoiceListState extends State<InvoiceList> {
  ...
  void _fetchDocuments() async {
    ...
    int s = 0;
    try {
      var invoiceQuery = await FirebaseFirestore.instance.collection('Invoice').get();
      ...
      await Future.wait(invoiceQuery.docs.map((invoiceDoc) async {
        ...
        allInvoiceLists.add(InvoiceListModel(
          ...
          due: invoiceDoc["Due"],
          accountID: invoiceDoc["Account ID"],retn: invoiceDoc["Return"],
  ...
  Future<void> _onInvoiceDetailsPOS(InvoiceListModel cst) async {
    ...
    if (cst.customerID == "0000") {
      ...
      Navigator.of(context).push(
        MaterialPageRoute(
          builder: (context) => InvoiceDetailsPOS(cst, _refreshdata, mn),
        ),
      );
    } else {
      await FirebaseFirestore.instance
                          ...
                          Row(
                            children: [
                              ...
                              Container(
                                ...
                                child: InkWell(
                                  onTap: () {
                                    PdfInvoice.generate(getlist(), _totalamount);
                                  },
                                  child: Image.asset(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Expanded(
                                    ...
                                    child: Container(
                                      margin: EdgeInsets.only(left: 7),
                                      child: Text( " ৳${NumberFormat('#,##,#00.##').format(_totalprofit)}",
                                        overflow: TextOverflow.ellipsis,
                                        style: TextStyle(
                                            fontSize: 12,
                                            fontWeight: FontWeight.bold,
