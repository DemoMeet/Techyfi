...
class MyAppBarEdit extends StatefulWidget implements PreferredSizeWidget {
  double height, width;
  MyAppBarEdit({required this.height, required this.width});
  @override
  _MyAppBarEditState createState() => _MyAppBarEditState();

  @override
  Size get preferredSize => Size.fromHeight(70);
}

class _MyAppBarEditState extends State<MyAppBarEdit> {
...
//         barrierDismissible: true,
//         Dialog(
//           insetPadding: EdgeInsets.only(right: 10, top: _height / 11),
//           backgroundColor: Colors.white,
//           elevation: 20,
//           alignment: Alignment.topRight,
//           child: Container(
