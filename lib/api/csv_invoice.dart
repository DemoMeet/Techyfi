...
class CsvInvoice {
  static void generateAndDownloadCsv(
      List<InvoiceListModel> customers, String fileName) {
    List<List<dynamic>> dataList = [InvoiceListModel.parameterNamescc()]..addAll(customers.map((customer) => customer.toCsvRowcc()));
