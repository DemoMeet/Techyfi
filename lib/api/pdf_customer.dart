...
class PdfCustomer {
  static Future<File> generate(List<Customer> invoice, double total) async {
    final pdf = Document();
    ...
    return PdfApi.saveDocument(
        "Customer_List${DateFormat('dd-MMM-yyyy-jms').format(DateTime.now())}.pdf",
        pdf);
  }
  ...
  static Widget buildInvoice(List<Customer> invoice, final ttf, final ttfbold) {
    final headers = [
      '#',
      'Customer Name',
      'Address',
  ...
  static Widget buildTotal(List<Customer> invoice, double total,final ttfbold) {
    return Container(
