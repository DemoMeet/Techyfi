...
class PdfInvoice {
  static Future<File> generate(List<InvoiceListModel> invoice, double total) async {
    final pdf = Document();
    ...
    return PdfApi.saveDocument(
        "Invoice_List${DateFormat('dd-MMM-yyyy-jms').format(DateTime.now())}.pdf",
        pdf);
  }
  ...
  static Widget buildInvoice(List<InvoiceListModel> invoice, final ttf, final ttfbold) {
    final headers = [
      '#',
      "Invoice No",
      "Invoice ID",
  ...
  static Widget buildTotal(List<InvoiceListModel> invoice, double total,final ttfbold) {
    return Container(
