...
class PdfCheque {
  static Future<File> generate(List<IssuedCheque> invoice, double total) async {
    final pdf = Document();
    ...
    return PdfApi.saveDocument(
        "Cheque_List${DateFormat('dd-MMM-yyyy-jms').format(DateTime.now())}.pdf",
        pdf);
  }
  ...
  static Widget buildInvoice(
      List<IssuedCheque> invoice, final ttf, final ttfbold) {
    final headers = [
      '#',
      'Name',
      'Account Name',
  ...
  static Widget buildTotal(
      List<IssuedCheque> invoice, double total, final ttfbold) {
    return Container(
