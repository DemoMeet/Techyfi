...
class PdfInvoiceA4PDF {
  static Future<File> generate(
    ...
    pdf.addPage(MultiPage(
      ...
      build: (context) => [
        Row(
          ...
          children: [
            ...
            Container(
              margin: EdgeInsets.only(left: 20),
              alignment: Alignment.centerLeft,
              child: Text(DateFormat.yMd().format(cst.invoiceDate),
                  style: TextStyle(
                    font: ttf,
                    fontSize: 10,
                    color: PdfColors.black,
        ...
        Container(
          margin: const EdgeInsets.only(top: 5, left: 90, right: 60),
          child: Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
        ...
        Container(
          margin: EdgeInsets.only(
              ...
              right: PdfPageFormat.a4.marginRight,
              top: 25),
          child: buildTotal(stock, cst, ttfbold),
        ),
      ],
  ...
  static Widget buildTotal(
      List<Stock> invoice, InvoiceListModel cst, final ttfbold) {
    return Container(
                  ...
                  child: Row(children: [
                    ...
                    Expanded(
                      ...
                      child: Container(
                        ...
                        padding:
                            EdgeInsets.symmetric(vertical: 5, horizontal: 5),
                        child: Text("${cst.total + cst.discount}",
                            style: TextStyle(
                                font: ttfbold,
                                color: PdfColors.white,
                                fontSize: 10)),
                  ...
                  child: Row(children: [
                    ...
                    Expanded(
                      ...
                      child: Container(
                        ...
                        padding:
                            EdgeInsets.symmetric(vertical: 5, horizontal: 5),
                        child: Text(cst.discount.toString(),
                            style: TextStyle(
                                font: ttfbold,
                                color: PdfColors.white,
                                fontSize: 10)),
